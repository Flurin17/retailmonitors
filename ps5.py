...
import ctypes
ctypes.windll.kernel32.SetConsoleTitleW("Digitec Monitoring | PS5")
...
def log(msg):
    ...
    try:
        print(logmsg)
        logmsg = logmsg + "\n"
        with open ('logging_ps5.txt', 'a', newline="") as f:
            f.write(logmsg)
    except:
        print("Can't save")
